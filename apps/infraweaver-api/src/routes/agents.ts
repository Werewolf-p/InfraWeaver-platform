...
const NODE_IMAGE = process.env.NODE_AGENT_IMAGE ?? 'onedev.rlservers.com/infraweaver/infraweaver-node:main';
const HUB_URL = process.env.HUB_URL ?? 'https://api.int.rlservers.com';
