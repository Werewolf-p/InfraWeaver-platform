...
import { z } from 'zod';
import { approveDiscovery, createPendingRegistration, getConnectedAgents, getHubPublicKeyBase64, getPendingDiscoveries, rejectDiscovery, } from '../lib/agent-registry.js';
...
agentsRoute.post('/pending/:agentId/approve', zValidator('json', z.object({
...
agentsRoute.post('/bootstrap', zValidator('json', z.object({
    clusterId: z.string().min(1).max(64).regex(/^[a-z0-9-]+$/),
...
function generateInstallManifest(token) {
