      ...
      <div className="bg-slate-900/60 border border-white/10 rounded-xl backdrop-blur-sm overflow-hidden">
        <table className="w-full">
          <thead><tr className="border-b border-white/10">
            ...
            <th className="text-left px-4 py-3 text-xs font-semibold text-slate-400">State</th>
            <th className="text-right px-4 py-3 text-xs font-semibold text-slate-400">Size (GiB)</th>
            <th className="text-right px-4 py-3 text-xs font-semibold text-slate-400">Used (GiB)</th>
            <th className="text-right px-4 py-3 text-xs font-semibold text-slate-400">Utilization</th>
          </tr></thead>
          <tbody>
            {volumes.map(v => {
              ...
              return (
                <tr key={v.name} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-4 py-3 text-sm text-right text-slate-300">{total.toFixed(1)}</td>
                  <td className="px-4 py-3 text-sm text-right text-slate-300">{used.toFixed(1)}</td>
                  <td className="px-4 py-3">
