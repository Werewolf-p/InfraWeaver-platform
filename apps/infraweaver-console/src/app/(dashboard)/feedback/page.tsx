...
type FeedbackStatus = "new" | "approved" | "dispatched" | "done" | "rejected";
...
export default function FeedbackReviewPage() {
  ...
  return (
    <PageScaffold
      ...
      subtitle="Review"
      description="Triage in-console reports. Approving an entry makes it eligible for the n8n fix workflow — nothing runs automatically."
      loading={isLoading}
