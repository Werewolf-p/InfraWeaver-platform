...
export function RoutesView() {
  ...
  // Sub-tab (routes / dns / ports / …) is local state so this view can be embedded
  // as the Workloads hub "routing" tab without colliding with the hub's own `?tab`
  // query param. "all" is the default landing sub-tab.
