          ...
          {actions.map((action, index) => {
            if (action.href) {
              return (
                <a
                  ...
                  className={cn(
                    "flex items-center gap-2.5 px-3 py-2 text-sm transition-colors hover:bg-gray-100 dark:hover:bg-[#1a1a1a]",
                    action.variant === "destructive" ? "text-red-400 hover:bg-red-500/10" : "text-gray-700 dark:text-[#d4d4d4]",
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-2.5 px-3 py-2 text-sm transition-colors hover:bg-gray-100 dark:hover:bg-[#1a1a1a]",
                  action.variant === "destructive" ? "text-red-400 hover:bg-red-500/10" : "text-gray-700 dark:text-[#d4d4d4]",
