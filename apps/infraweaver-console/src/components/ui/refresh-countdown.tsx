...
export function RefreshCountdown({
  ...
  return (
    <div
      role="status"
      aria-label={isFetching ? "Refreshing" : "Auto-refresh active"}
    ...
    >
      ...
      <span aria-hidden="true" className="font-medium text-slate-700 dark:text-slate-200">{isFetching ? "Refreshing…" : `Refresh in ${remaining}s`}</span>
