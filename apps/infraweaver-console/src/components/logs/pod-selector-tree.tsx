...
export function PodSelectorTree({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-slate-100 dark:bg-slate-950/40">
      <div className="border-b border-gray-200 dark:border-white/10 p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 dark:border-white/10 bg-slate-100 dark:bg-slate-950 py-2 pl-9 pr-3 text-sm text-gray-900 dark:text-white placeholder:text-slate-500 outline-none focus:border-indigo-500/50"
          />
        </div>
      </div>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          selectedKey === key
                            ? "border-indigo-500/40 bg-indigo-500/10 text-gray-900 dark:text-white"
                            : "border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-white/[0.03] text-slate-700 dark:text-slate-300 hover:border-white/10 hover:bg-white/[0.05]"
                        )}
                      >
