...
foreach ( array( 'class-iwsl-response-scan.php', 'class-iwsl-media-protection.php', 'class-iwsl-seo-alt-text.php', 'class-iwsl-seo-console.php', 'class-iwsl-elementor-blocks.php', 'class-iwsl-media-folders.php', 'class-iwsl-media-folders-ui.php', 'class-iwsl-media-library.php', 'class-iwsl-media-detail.php', 'class-iwsl-media-editor.php', 'class-iwsl-security-headers.php' ) as $iwsl_new_inc ) {
