...
foreach ( array( 'class-iwsl-response-scan.php', 'class-iwsl-media-protection.php', 'class-iwsl-seo-alt-text.php', 'class-iwsl-elementor-blocks.php', 'class-iwsl-media-folders.php', 'class-iwsl-media-folders-ui.php', 'class-iwsl-security-headers.php' ) as $iwsl_new_inc ) {
...
$suites = array( 'jcs', 'slhdsa', 'slhdsa-192f', 'verifier', 'enrollment', 'wp-store', 'rotation', 'plugin', 'command-handler', 'purge', 'entitlements', 'feature-switches', 'media-optimizer', 's3-client', 'media-offload', 'email-delivery', 'redirects', 'white-label', 'db-optimizer', 'page-cache', 'config-editor', 'ui-help',
	...
	'lazy-load', 'cdn-rewrite', 'duplicate-post', 'seo-audit', 'svg-upload', 'broken-link-scan', 'maintenance-mode', 'scheduled-db-cleanup', 'activity-log', 'auto-convert', 'statistics', 'cookie-consent', 'seo-suite', 'seo-alt-text', 'perf-audit', 'media-protection', 'media-folders', 'response-scan', 'security-headers', 'elementor-blocks', 'teardown', 'speed-pack' );
