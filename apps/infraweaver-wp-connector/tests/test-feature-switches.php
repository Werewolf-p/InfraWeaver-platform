...
iwsl_assert_same( 20, count( IWSL_Feature_Switches::switchable() ), 'exactly 20 switchable features' );
...
iwsl_assert_same( 20, count( $flag_map ), 'admin exposes all 20 tier-gated features' );
