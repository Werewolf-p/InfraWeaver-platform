...
4. If you prefer automation, use the existing GitHub Actions maintenance workflow (`Maintenance — Scheduled Operations`, task `etcd-defrag`) from the Actions tab.
