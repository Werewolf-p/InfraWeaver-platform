...
| `.github/workflows/` | CI/CD, deploy, and operations pipelines |
...
- **Pull requests** validate changed workspaces before merge.
- **Pushes to `main`** trigger service-specific build and deployment workflows.
- **ArgoCD** remains the source of truth for Kubernetes workloads.
