...
# platform-wildcard-cert: HTTP-01, usually fast (~2-5 min)
# int-platform-wildcard-cert: DNS-01 via Cloudflare, can take up to 10 min
# Both may be rate-limited on repeated deploys — warn but don't fail
for cert in platform-wildcard-cert int-platform-wildcard-cert; do
...
for secret in platform-wildcard-tls platform-int-wildcard-tls; do
